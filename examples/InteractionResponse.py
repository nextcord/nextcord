...
@client.slash_command(name="ping", guild_ids=[GUILD_ID]) # Call The Function Define The Name If You Need It For Dynamic Help Commands And Which Guilds Get The Slash Command.
