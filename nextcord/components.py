...
Component classes in this file should be ordered by the Discord Component ID. ActionRow is first because it has a
component ID of 1, Button second because it's 2, etc.
...
class ChannelSelect(_SelectComponent):  # Component type 8
    ...
    async def wait_for_interaction(
        ...
        def inter_arg_func(inter: Interaction):
            resolved_channels = inter._resolve_channels()
...
class Label(Component):  # Component type 18
    """Represents a Label component object.
    ...
    ----------
    label
        Main text for the label.
    component
        Component to wrap the label around.
    description
    ...
    """Main label text."""
    component: Component
    """Component that this label wraps."""
    description: str  # Can be MISSING
    """Description of the label. Can be ``MISSING``"""
    ...
    def __init__(
        ...
        *,
        ...
        super().__init__(component_type=ComponentType.label, component_id=component_id)
    ...
    @classmethod
    def from_dict(cls, payload: comp_payloads.Label):
        return cls(
            label=payload["label"],
