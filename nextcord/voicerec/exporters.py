...
def export_as_MP3(audio_data):
    ...


# MP4

def export_as_MP4(audio_data):
    ...


# M4A

def export_as_M4A(audio_data):
    ...


# MKA

def export_as_MKA(audio_data):
    ...


# MKV

def export_as_MKV(audio_data):
    ...


# OGG

def export_as_OGG(audio_data):
    ...
